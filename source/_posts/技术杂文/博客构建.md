...
## ELog配置
`<font style="background-color:rgba(142, 150, 170, 0.14);">elog.config.js</font>`<font style="background-color:rgba(142, 150, 170, 0.14);">中存在三个字段</font>
...
<font style="color:#000000;background-color:rgba(255, 255, 255, 0);">将`site.tags.length`作为参数替换到翻译字符串的占位符（</font>`<font style="color:#000000;background-color:rgba(255, 255, 255, 0);">%d</font>`<font style="color:#000000;background-color:rgba(255, 255, 255, 0);">），生成最终文本</font>

## <font style="color:#000000;">Disqus评论系统</font>
主要配置的是主题的config.yaml文件:
...
## 谷歌网站分析Google Analysis
[https://www.xnbeast.com/google-analytics/#elementor-toc__heading-anchor-6](https://www.xnbeast.com/google-analytics/#elementor-toc__heading-anchor-6)

然后将获得的![](/images/f8f4004a2220729164769e54a5f3e82c.png)

配置进主题yaml

## 微软的clarity服务
<font style="color:rgb(255, 255, 255);background-color:rgb(29, 31, 32);">Clarity 特别适合不想使用 Google Analytics（Google国内无法使用，而百度的太拉跨） 的站长，或是希望补充更多可视化行为数据的用户。</font>
