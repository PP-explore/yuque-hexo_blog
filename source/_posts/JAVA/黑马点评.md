...
现在<font style="color:rgb(221, 212, 202);background-color:rgb(29, 31, 32);">我们可以将一部分的工作交给Redis，并且不能直接去调用Redis，而是通过开启一个独立的子线程去异步执行，从而大大提高效率</font>
